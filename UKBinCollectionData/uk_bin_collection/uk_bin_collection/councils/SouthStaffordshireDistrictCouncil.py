...
class CouncilClass(AbstractGetBinDataClass):
    ...
    def parse_data(self, page: str, **kwargs) -> dict:
        ...
        if (
            van_collection_msg
            and "van collection" in van_collection_msg.get_text().lower()
        ):
            # This property has van collection, no standard dates available
            return bin_data

        # Find next date
        collection_date_elem = collectionDatesSection.find(
        ...
        if collection_date_elem:
            ...
            # convert to date
            collection_type_elem = collectionDatesSection.find(
