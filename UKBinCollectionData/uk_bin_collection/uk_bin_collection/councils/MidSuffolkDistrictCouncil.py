    ...
    def parse_data(self, page: str, **kwargs) -> dict:
        ...
        def find_next_collection_day(original_date):
            ...
            while attempts < max_attempts:
                ...
                if check_date.date() in bank_holiday_dates:
                    ...
                    is_major_holiday = (
                        "Christmas" in holiday_name
                        or "Boxing" in holiday_name
                        or "New Year" in holiday_name
                    )
        ...
        if garden_collection_week:
            ...
            for gardenDate in garden_dates:
                # Calculate initial collection date
                initial_date = datetime.strptime(gardenDate, "%d/%m/%Y") + timedelta(
                    days=offset_days_garden
                )
                ...
                collection_date = find_next_collection_day(
